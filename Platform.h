...
#define LOW_STOP_PINS {11, 28, 60, 31}			// Full array endstop pins for Duet + Duex4 is {11, 28, 60, 31, 24, 46, 45, 44}
#define HIGH_STOP_PINS {11, 28, -1, -1}     // X and Y are "bidirectional"
...
#define HOTEND_FAN_PIN X6 //Temperature-controlled hotend cooling fan. pin D34 is PWM capable but not an Arduino PWM pin - use X6 instead
